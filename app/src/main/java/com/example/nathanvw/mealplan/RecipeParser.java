...
class RecipeParser {
    ...
    void parseIngredientsFromText(String raw_text, Recipe recipe){
        ...
        for (String ing_text: ings_text) {
            ...
            //recipe.addNewIngredient(name,amount,unit,TextUtils.join(", ", details));
        }
    }
